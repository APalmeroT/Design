            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <p class="descripcion-atraccion">Cambia por el de San Fernando al entrar a Tamaulipas en el municipio de Burgos. hay extensas llanuras y montes altos en la parte colindante con San Carlos, el río Conchos atraviesa el municipio antes de llegar a su desembocadura en la Laguna Madre.</p>
                        <img src="http://167.71.185.28/img/burgos/cochos.png" alt="" class="featured__img">
