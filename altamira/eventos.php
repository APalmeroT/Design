            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <p class="descripcion-atraccion">El 2 de mayo, fundación de Altamira por don José de Escandón, conde de Sierra Gorda en 1749</p>
                        <img src="http://167.71.185.28/img/altamira/fundacion.jpg" alt="" class="featured__img">


                        <h2 class="titulo-atraccion">Conmemoración de la lucha con las fuerzas del General Mier y Terán</h2>
                       <p class="descripcion-atraccion">Antes de su rendición, el 11 de septiembre de 1829, el general Barradas llegó a Altamira, donde sostuvo una lucha con las fuerzas del General Mier y Terán.</p>
                       <img src="http://167.71.185.28/img/altamira/conme.jpg" alt="" class="featured__img">
