            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <p class="descripcion-atraccion">Plaza Municipal se encuentra en Municipio de Aldama. Esta empresa se desempeña en la siguiente industria: Casas, cabañas y complejos turísticos.</p>
                        <img src="http://167.71.185.28/img/aldama/plaza.jpg" alt="" class="featured__img">
                    </div>
                </div>
            </section>
        </div>
