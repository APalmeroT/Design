            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <p class="descripcion-atraccion">Una de las fiestas populares es la que se realiza, año con año, para festejar la fundación de la Villa. Se inicia la última semana de abril con un desfile de carretas alegóricas, simulando la llegada de los primeros pobladores.</p>
                        <img src="http://167.71.185.28/img/aldama/villa.jpg" alt="" class="featured__img">
                    </div>
                </div>
            </section>
        </div>
