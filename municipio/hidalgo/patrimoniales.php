            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="tipo-atraccion">Museos</h2>
                        <h2 class="titulo-atraccion">Museos del estado de Hidalgo</h2>
                        <p class="descripcion-atraccion">En el municipio sólo se encuentra la Casa de Cultura de Hidalgo

</p>
<img src="http://167.71.185.28/img/hidalgo/museos.jpg" alt="" class="featured__img">
                    </div>
                </div>
            </section>
        </div>
