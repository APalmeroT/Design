            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <p class="descripcion-atraccion">Esta costa de arenas doradas y aguas turquesas regala lugares inmejorables para pasar días de playa espectaculares. Aquí tienes todos los servicios necesarios, además del acceso a los equipos indispensables para la práctica de los deportes acuáticos de tu preferencia: vela, snorkel, buceo, kayak o windsurf.</p>
                        <img src="http://167.71.185.28/img/cdmadero/playa.jpg" alt="" class="featured__img">

                        <h2 class="titulo-atraccion">Río Pánuco</h2>
                        <p class="descripcion-atraccion">Si te gustan los paseos de horizontes marinos, una caminata por el malecón de Miramar. Desde allí se puede disfrutar de las seductoras vistas del mar del Golfo, por un lado, y de las aguas del río Pánuco.</p>
                        ...
                        <p class="descripcion-atraccion">Es sorprendente pensar que este cuerpo de agua se encuentra en el corazón de la ciudad: cocodrilos, garzas y flamencos habitan entre los manglares y aguas transparentes. Una experiencia gratificante tomar una lancha para recorrer el área y emocionarse con su exótica fauna y paisajes.</p>
