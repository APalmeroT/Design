            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">Parque ecologico </h2>
                        <p class="descripcion-atraccion">Este parque se llema tres Mesas es un parque de energía eólica situado en el municipio de Llera, Tamaulipas.</p></p>
                        <img src="http://167.71.185.28/img/llera/parques.jfif" alt="" class="featured__img">
