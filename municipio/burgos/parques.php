            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">kiosco de la plaza principal</h2>
                        <p class="descripcion-atraccion">kiosco de la plaza principal construido en 1982</p>
                        <img src="http://167.71.185.28/img/burgos/plaza.png" alt="" class="featured__img">
                    </div>
                </div>
            </section>
        </div>
