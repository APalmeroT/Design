            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <p class="descripcion-atraccion">El municipio cuenta con algunos cascos de las ex haciendas, como la del Caracol de Álvarez y la del Capulín; también con un manantial al cual se le conoce como el Pantanito y se localiza a 2 kilómetros de distancia de la cabecera municipal, sobre el camino Bustamante-Las Antonias, lugar densamente poblado de vegetación y abundante agua, considerado como un fuerte atractivo natural.</p>
                        <img src="http://167.71.185.28/img/bustamante/ex.png" alt="" class="featured__img">
